"""
Generate a 5-way vertical corner joint (Z+, Z-, Y+, Y-, X-) for 16 mm ID steel tubing.
This creates a vertical hub with upward, downward, forward, backward, and leftward connectors.

Run:
    python corner_joint_5way_vertical.py    # writes corner_joint_5way_vertical.stl
"""
...
HUB_SIZE      = 20.0     # cube hub size (mm) - enlarged for 5-way strength
...
# Create cylinders for Z+, Z-, Y+, Y-, X- directions
...
write_ascii_stl(facets, outfile, name='corner_5way_vertical')
